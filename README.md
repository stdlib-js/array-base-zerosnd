...
```
The previous example will load the latest bundled code from the umd branch. Alternatively, you may load a specific version by loading the file from one of the [tagged bundles](https://github.com/stdlib-js/array-base-zerosnd/tags). For example,

```javascript
zerosnd = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/array-base-zerosnd@v0.1.0-umd/browser.js' )
```
